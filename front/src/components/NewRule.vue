<template>
    <form>
        <div class="form-group" @submit.prevent="onSubmit">
            ...
            <small id="nameHelp" class="form-text text-muted">Identifiant de l'opération</small>
            ...
            <small id="amountHelp" class="form-text text-muted">Identifiant de l'opération</small>
